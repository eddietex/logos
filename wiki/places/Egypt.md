---
type: place
also_known_as: [Mizraim, Misraim, the land of Ham]
tags: [place]
---
# Egypt
...
Ham's second son, and the Hebrew name of a country for the rest of the Bible.

> **6** The sons of Ham were: Cush, Mizraim, Put, and Canaan.
> **13** Mizraim became the father of Ludim, Anamim, Lehabim, Naphtuhim,
> **14** Pathrusim, Casluhim (which the Philistines descended from), and Caphtorim.

*Miṣrayim* is the standard Hebrew word for Egypt in every book of the canon, and
[[The Table of Nations]] lists it as a person. The form is a dual — *the two Miṣrs*, plausibly Upper
and Lower Egypt, though the ending may be locative rather than numeral. Egypt's own name for itself
was *kmt*, *the black land*, after the Nile silt; the Psalms twice call it *"the land of Ham"* (Psalm
105:23, 27; 106:22), which is either a play on that or a straight reading of Genesis 10:6.

**Its seven descendants are the chapter's only entries that are plural from the start** — Ludim,
Anamim, Lehabim, Naphtuhim, Pathrusim, Casluhim, Caphtorim — which is a reminder that the Table's
"sons" are peoples wherever it suits the text to say so. **Pathrusim** is secure: *Pathros* is Upper
Egypt, and Isaiah 11:11, Jeremiah 44:1, and Ezekiel 29:14 all use it. **Caphtorim** is Crete. The
others are not identified with confidence.

**The Philistine parenthesis is a known crux.** Genesis 10:14 derives the Philistines from Casluhim;
Amos 9:7, Jeremiah 47:4, and Deuteronomy 2:23 derive them from **Caphtor**, which is Crete and which
is the very next name in the verse. The simplest account is that the parenthesis has slipped one name
...
Isaiah 19:23–25 closes with Egypt and [[Assyria]] and Israel worshipping together and Egypt called
*"my people"*.
