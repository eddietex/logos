...
A binding, sworn relationship between parties, with stated obligations, a sign, and a curse for
breach — and, in the Bible, the primary category under which God relates himself to creatures. It
becomes the organizing structure of the whole canon: the two divisions of the Christian Bible are
named after it.

The Hebrew is **bərît**. Its etymology is uncertain (proposals include *bārâ*, to eat, from the
covenant meal, and an Akkadian *birītu*, a fetter or bond), and the standard idiom for making one is
not *to make* but **to cut** a covenant — *kārat bərît* — from the ceremony in which animals are cut
in half and the parties pass between the pieces, which Genesis 15:9–17 stages in full and Jeremiah
34:18–20 explains: *"the calf which they cut in two and passed between its parts."* The implied
self-curse is the point. *May I be so divided if I break this.*

**Its first appearance in Scripture is Genesis 6:18**, in
[[Noah and the Flood]], and every feature of the placement is worth holding on to:

- It is spoken **inside a sentence of universal death.** God has just said *"I will bring an end to
  all flesh"* (6:13) and *"Everything that is in the earth will die"* (6:17), and the very next word
  is *"But I will establish my covenant with you"*. The first covenant in the Bible is not an
  alternative to judgment; it is what is offered inside one.
- It is **unilateral.** Noah is told what to build and who to bring. He is not asked, he does not
  agree, he does not sign, and he says nothing at all. The obligations run one way.
- The verb is **establish**, not **cut.** *Hēqîm bərît* — literally *cause a covenant to stand*.
  This is not the ordinary idiom, and the difference has been argued about for centuries (see
  below).
...
perpetuate an arrangement that already exists, and infers from 6:18 a covenant with creation itself,
implicit in Genesis 1–2, which the flood covenant renews rather than inaugurates. Against it: the
same verb is used at Genesis 17:7 and 17:19 of covenants that Genesis 15 and 17 are plainly setting
up for the first time, so the verb cannot carry that much weight alone. What can be said safely is
that Genesis never uses *kārat* of the Noahic covenant, that no ceremony accompanies it, and that
God's obligation in it is stated without any human party undertaking anything — which makes it the
least conditional covenant in the Bible and the one that most resembles a decree.

And the covenant of Genesis 9 has a feature no later covenant has: its scope is not a person, a
family, or a nation, but **"every living creature of all flesh that is on the earth"** — the animals
...
- **Deuteronomy** — the whole book is shaped like a second-millennium suzerain–vassal treaty:
  historical prologue, stipulations, witnesses, blessings and curses (chs. 27–28), and a deposit of
  the text. The form is well enough attested from Hittite archives that the parallel is not
  seriously disputed.
...
- **Ezekiel 36:26–27; 37:26** — the same promise as a new heart and an everlasting covenant of
  peace.
- **Luke 22:20; 1 Corinthians 11:25** — *"This cup is the new covenant in my blood"*: the Jeremiah
  text claimed at the last supper.
- **Hebrews 8–10** — the sustained New Testament argument that the new covenant supersedes the old,
  built by quoting Jeremiah 31 at length; and Hebrews 9:16–17's play on *diathēkē* as both covenant
  and **will**, which requires a death to take effect.
- **Galatians 3:15–29; Romans 4** — Paul's argument that the Abrahamic covenant precedes Sinai and
  is not annulled by it, which is why the promise reaches the nations.
- **Revelation 21:3** — *"Behold, God's dwelling is with people … they will be his people, and God
  himself will be with them"*: the covenant formula of Leviticus 26:12 as the last thing said about
  the new creation.
