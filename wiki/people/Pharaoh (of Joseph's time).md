---
type: person
also_known_as: [Pharaoh, parʿōh]
tags: [person]
---
# Pharaoh (of Joseph's time)

*Qualified by the patriarch he appears with, per the `AGENTS.md` convention for figures known only by a
title. **Pharaoh is not a name** — Egyptian *pr-ʿȝ*, *the great house* — and Genesis and Exodus never
supply a personal name for any Pharaoh they narrate. This is the second of at least three: see
[[Pharaoh (of Abram's time)]], and the Pharaoh of the Exodus ahead.*

## Overview

**He enters Scripture as a possessive.**

> **36** The Midianites sold him into Egypt to Potiphar, **an officer of Pharaoh’s**, the captain of the
> guard. (37:36)

**That is the whole of him in Genesis 37** — a genitive attached to the man who buys Joseph — and the
page exists because this is where he first appears, not because the verse says anything about him. **The
wiki's convention is to apply the period qualifier from the first appearance rather than retrospectively**,
which is why the page is opened on a possessive and left thin.

### Is he one man or two?

**Genesis gives no indication either way, and the wiki does not decide.** The figure whose officer owns
Joseph at 37:36 and whose prison holds him at 40:3 is the same court as the figure who dreams at 41:1 and
promotes him at 41:40 — **but thirteen years pass between the sale and the promotion** (Joseph is
seventeen at 37:2 and thirty at 41:46), and a further eighty years of narrative follow before Joseph's
death. **Genesis uses the bare title throughout and never marks a change of reign**, so a reader cannot
tell whether one king or a succession is meant. **The page treats him as the Pharaoh of the whole Joseph
period** and says so, rather than splitting him on evidence the text does not give.

**Nor does Genesis supply a dynasty or a date**, and the wiki declines to import one. Identifications
have been proposed from the Twelfth Dynasty through the Hyksos period; **none is recoverable from
...
- [[Joseph Sold into Slavery]] — Genesis 37:36; **one word, in the genitive.** *"An officer of
...
- [[Jacob]] — whom he settles in Goshen and who blesses him, the only patriarch to bless a foreign king
- [[Abimelech (of Abraham's time)]], [[Abimelech (of Isaac's time)]] — the other foreign rulers the
  patriarchs deal with, and the other title the wiki qualifies by period for the same reason
